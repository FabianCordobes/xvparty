...
const DetailsSection = () => {
  return (
    <div className="pb-20 text-center xl:ml-[15rem] flex flex-col place-items-center" id="details">
      ...
      <motion.div
        className="mb-[30px] relative h-[660px] bg-contain bg-center w-[375px]"
      ...
      >
        <motion.div className="max-w-[300px]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
          <p className="text-[1.7rem] text-black relative left-[40px] top-[230px]">
          ...
          <h2 className="text-[2.5rem] text-black font-extrabold relative left-[35px] top-[230px]">Mis 15 años</h2>
        </motion.div>
      </motion.div>
